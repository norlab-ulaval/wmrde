...
public:
	//buffer sizes
	static const int MAXNF = 20;		//max number of frames
	static const int MAXNW = 10;			//max number of wheels (or sprockets)
	static const int MAXNT = 6;			//max number of tracks (used to determine max number of contact points)
	static const int MAXNA = MAXNF-1;	//max number of actuated frames
	static const int MAXNJC = 4;		//max number of (holonomic) joint constraints
